...
@WebServlet("/AddJob")
public class RecAddJob extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int rid=(int)session.getAttribute("recId");
		...
		try {
			...
			RequestDispatcher rd=request.getRequestDispatcher("Recruiter/RecruiterHome.jsp");
