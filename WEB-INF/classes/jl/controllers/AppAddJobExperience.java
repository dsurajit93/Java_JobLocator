...
@WebServlet("/AppAddJobExperience")
public class AppAddJobExperience extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean status=apd.createJobProfile(app);
		if(status) {
			response.sendRedirect("Applicant/AppUploadImage.jsp");
		}
		else {
			request.setAttribute("msg", "Something wrong !!! Please Try Again");
			RequestDispatcher rd=request.getRequestDispatcher("Applicant/ApplicantJobDetails.jsp");
