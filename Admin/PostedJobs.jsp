...
<tr><td colspan="2" align="center">
	<a href="/JobLocator/AdminGetJobDetails?jid=<%=jb.getId() %>" id="mod">EDIT</a>
	<a href="/JobLocator/AdminDeleteJob?jid=<%=jb.getId() %>" id="mod" onclick="return ConfirmDelete();">DELETE</a>
</td></tr>
</table>
</div>
<%
